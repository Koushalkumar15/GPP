...
$sql8 = "SELECT count(email) as count FROM camera_worker WHERE email = '$email'";
...
$sql5 = "SELECT coins,email FROM users where role='worker'";
...
<div class="wrapper">
  <!-- HEADER -->
<?php
 include("includes/header_index_worker.php");
 ?>

  <!-- Left side column. contains the logo and sidebar -->
  <!-- SIDEBAR -->
  <?php
 include("includes/sidebar_index_worker.php");
 ?>
					  ...
					  <div class="box-body">
						  <div class="text-center">
							  <div class="easypie" data-percent="100" data-bar-color="#faa700" data-scale-color="transparent">
								<span class="icon-box"><i class=" fa fa-star text-warning"></i></span>
							  </div>
							  <h3 >3</h3>
							  <p class="mb-0">My Locality Rank</p>
							  <p class="text-fade"><small></small></p>
...
$sql7 = "SELECT *  FROM camera_worker WHERE email = '$email'";
...
?>
							<tr>
							<td><?php  echo "<a href='uploads_worker/" . $row7['image'] . ".jpg'  data-toggle='lightbox' data-gallery='multiimages'><img src='uploads_worker/" . $row7['image'] . ".jpg' alt='Segregated Result'  style='width:50px; border-radius:50%;' >"; ?></td>
