      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="../index_worker.php"><i class="ti-more"></i>Home</a></li>
            <li><a href="../pages/worker_profile.php"><i class="ti-more"></i>Worker Profile</a></li>
...
<!-- 		
       ...
       <!-- <li class="treeview">
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
		  <li><a href="../pages/extra_calendar.php"><i class="ti-more"></i>Create Team</a></li>
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../pages/ecommerce_products.php"><i class="ti-more"></i>Reedem </a></li> -->
...
<!-- 		
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="ai_camera_worker.php"><i class="ti-more"></i>Camera </a></li>
            <li><a href="ai_gallery_worker.php"><i class="ti-more"></i>Gallery</a></li>
