      ...
      <!-- sidebar menu-->      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin_profile.php"><i class="ti-more"></i>Admin Profile</a></li>
...
<!-- 		
  ...
  <!-- 		          <li class="treeview">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="map.php"><i class="ti-more"></i>Location Ratings</a></li>
...
<!-- 		
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/extra_taskboar.php"><i class="ti-more"></i>Camera</a></li>
