      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Worker">
            ...
            <ul class="dropdown-menu animated flipInX">
              ...
              <!-- Menu Body -->
              <li class="user-body">
				    <a class="dropdown-item" href="pages/worker_profile.php"><i class="ion ion-person"></i> My Profile</a>
