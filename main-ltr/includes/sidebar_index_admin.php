      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview active">
          ...
          <ul class="treeview-menu">
            <!-- <li><a href="index_admin.php"><i class="ti-more"></i>Home</a></li> -->
            <li><a href="pages/admin_profile.php"><i class="ti-more"></i>Admin Profile</a></li>
...
<!-- 		
  ...
  <!-- 		          <li class="treeview">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="pages/map.php"><i class="ti-more"></i>Location Ratings</a></li>
...
<!-- 		
		...
		<!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/extra_taskboard.php"><i class="ti-more"></i>Camera</a></li>
