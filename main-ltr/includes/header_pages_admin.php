...
<header class="main-header">
	...
	<i class="fa fa-lightbulb-o " aria-hidden="true"></i>   
	  ...
	  <?php
			...
			$sql2="SELECT coins from `users` where email='$email'";
	...
	?>
	  ...
	  <!-- <button type="button"  style="cursor:context-menu" class="btn btn-primary"> -->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              ...
              <!-- Menu Body -->
              <li class="user-body">
				    <a class="dropdown-item" href="admin_profile.php"><i class="ion ion-person"></i> My Profile</a>
					<!-- <a class="dropdown-item" href="view_team.php"><i class="fa fa-circle-o-notch"></i> My Coins</a> -->
