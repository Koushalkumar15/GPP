...
<!-- 		
  ...
  <!-- 		          <li class="treeview">
      ...
      <!-- <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="pages/ecommerce_products.php"><i class="ti-more"></i>Location Ratings</a></li> -->
...
<!-- 		
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/ai_camera_worker.php"><i class="ti-more"></i>Camera</a></li>
            <li><a href="pages/ai_gallery_worker.php"><i class="ti-more"></i>Gallery</a></li>
